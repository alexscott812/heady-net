...
const Shows = () => {
  ...
  const { data: songsData } = useSongs({ limit: 1000 }, { staleTime: Infinity });
  const { data: venuesData } = useVenues({ limit: 1000 }, { staleTime: Infinity });
    ...
    <>
      <PageHead>
        <Flex h={14} alignItems="center" justifyContent="space-between">
          <Box>
            <Heading as="h4" fontWeight="semibold" size="md">Shows</Heading>
          </Box>
          <Spacer />
          <Button
            colorScheme="gray"
